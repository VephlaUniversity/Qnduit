...
export const EmployerPlans = ({ selectedPlan, onSelectPlan, onPlanAction }) => {
  const bronzeIcon = (
    <svg
  ...
  const platinumIcon = (
    ...
    >
      <path
        d="M12 2L15.09 10.26H24L17.55 15.7L20.64 23.96L12 18.5L3.36 23.96L6.45 15.7L0 10.26H8.91L12 2Z"
        fill="white"
      />
    </svg>
  );
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
      <PlanCard
        planType="bronze"
        title="Bronze"
        description="For straightforward hires"
        price={6.99}
        icon={bronzeIcon}
        features={[
          "Post unlimited jobs",
      ...
      <PlanCard
        ...
        ctaText="Start Contacting Talent →"
      ...
      <PlanCard
        planType="platinum"
        title="Platinum"
        description="All-in hiring advantage"
        price={12.99}
        icon={platinumIcon}
        features={[
          "Post unlimited jobs",
