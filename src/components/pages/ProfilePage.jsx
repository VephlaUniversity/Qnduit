        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1">
            <div className="bg-[#1A1F2E] rounded-2xl p-8">
              ...
              {activeTab === "portfolio" && (
                <div>
                  ...
                  <div className="bg-gray-600 rounded-lg mb-6 aspect-video flex items-center justify-center">
                    {portfolioItems[currentPortfolioIndex].type === "video" ? (
              ...
              {activeTab === "contact" && (
                <div>
                  <h2 className="text-xl font-bold mb-6">Contact Candidate</h2>
          ...
          <div className="w-96 flex-shrink-0">
            <div className="bg-[#1A1F2E] rounded-2xl p-6 space-y-6">
              <div className="space-y-4">
