    ...
    <>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-10">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }}
              className="text-white text-base lg:text-lg max-w-3xl mx-auto"
            >
      ...
      <section className="py-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          {/* Description Box */}
          <motion.div
            className="bg-[#1A1A1C] rounded-3xl p-8 lg:p-12 mb-12"
            variants={staggerContainer}
            initial="initial"
            whileInView="animate"
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Our Mission */}
            <motion.div
              className="bg-[#1A1A1C] rounded-3xl p-8 lg:p-10 relative overflow-hidden"
              variants={staggerContainer}
              initial="initial"
              whileInView="animate"
