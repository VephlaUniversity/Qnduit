        ...
        <div className="flex gap-6">
          ...
          >
            <div className="bg-[#191D23] rounded-xl p-6 space-y-6 lg:sticky lg:top-6">
              {/* Search keyword */}
              <div>
                <h3 className="text-white mb-3">Filter Result</h3>
              ...
              {/* Work type */}
              <div>
                <h3 className="text-white mb-3">On-Site / Remote</h3>
                <select
              ...
              {/* Job type */}
              <div>
                <h3 className="text-white mb-3">Job Type</h3>
                <select
                  value={jobTypeFilter}
                  onChange={(e) => {
              ...
              {/* Posted */}
              <div>
                <h3 className="text-white mb-3">Posted</h3>
                <div className="relative">
                  <select
                    value={postedAnytime}
                    onChange={(e) => {
              ...
              {/* Seniority */}
              <div>
                <h3 className="text-white mb-3">Seniority Level</h3>
                <div className="relative">
                  <select
