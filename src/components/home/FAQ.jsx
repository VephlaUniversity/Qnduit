  ...
  return (
    <section className="max-w-4xl mx-auto px-6 lg:px-8 py-20">
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              backgroundColor: faqToggle ? "#F5C518" : "#3B82F6",
            }}
          >
            <div
      ...
      <AnimatePresence mode="wait">
        <motion.div
          key={faqToggle ? "talents" : "employers"}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          {currentFaqData.map((faq, index) => (
            <motion.div
              ...
              className={`border border-gray-400 rounded-2xl transition-colors hover:bg-[#1A1A1A] ${
