import { Crown, Star, StarIcon, Stars, StarsIcon } from "lucide-react";
        ...
        {pricingToggle ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-[#2A2A2A] rounded-3xl p-8">
              ...
              <p className="text-gray-400 mb-6">Get Started Instantly</p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300">Apply to jobs</span>
                </div>
                <div className="flex items-center">
                  <svg
                    className="w-5 h-5 text-green-400 mr-3"
                  ...
                  <span className="text-gray-300">View jobs details</span>
                </div>
                <div className="flex items-center">
                  <svg
                    className="w-5 h-5 text-green-400 mr-3"
                  ...
                  <span className="text-gray-300">Build your profile</span>
                </div>
              </div>

              <button className="w-full border border-[#5F8DD7] text-gray-100 py-4 rounded-full hover:bg-[#333333] hover:text-white transition-all duration-200 cursor-pointer">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-2xl font-bold">Public Listing</h3>
              </div>
              <p className="text-gray-300 mb-6">Your ticket to visibility</p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-200">Stay discoverable 24/7</span>
                </div>
                <div className="flex items-center">
                  <svg
                    className="w-5 h-5 text-green-400 mr-3"
              ...
              <button className="w-full bg-[#09111F] text-white py-4 rounded-full hover:bg-[#071326] transition-colors border-1 border-[#5F8DD7] cursor-pointer">
                List My Profile Here →
              </button>
            </div>
          </div>
        ) : (
